...
class tmal():
    ...
    def show_info(self):
        ...
        self.box.heading('3', text='评论数量')
        self.box.heading('4', text='商品链接')
    ...
    def export(self):
        ...
        excel = ExcelUtil()
        excel.writeExcel(0, 0, "商品标题")
        excel.writeExcel(0, 1, "价格")
        excel.writeExcel(0, 2, "评论数量")
        excel.writeExcel(0, 3, "商品链接")
        row = 0
        for i in items:
            row = row + 1
